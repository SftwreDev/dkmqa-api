# Generated by Django 3.1 on 2020-09-10 18:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(auto_now=True, verbose_name='Date Created')),
                ('created_by', models.CharField(max_length=100, verbose_name='Created by')),
                ('categoryName', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='category.category1', verbose_name='Category Name')),
            ],
        ),
        migrations.CreateModel(
